      ...
      <div className="min-h-screen w-full bg-gradient-to-tr from-[#45D1DD] to-gray-300">
        ...
        <div className="px-[3vw] py-[3vw]">
          <div className="w-[90vw] mx-auto flex flex-col lg:flex-row gap-6">
            ...
            <div className="bg-white rounded-3xl shadow-md p-[2vw] flex flex-col w-[30vw] ">
              <Image
            ...
            <div className="bg-white rounded-3xl shadow-md p-[2vw] w-[60vw] h-[33vw] overflow-x-auto  flex flex-col ">
              <div>
                    ...
                    <tbody className="text-gray-700 text-[1vw]">
                      {[
                        ...
                        >
                          ...
                          <td className="py-[1vw] text-gray-900">{app.role}</td>
                          <td className="py-[1vw] text-gray-600">{app.date}</td>
                          <td className="py-[1vw]">
                            <span
